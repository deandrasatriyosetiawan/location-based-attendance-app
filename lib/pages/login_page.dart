...
class _LoginPageState extends State<LoginPage> {
  ...
  void _login() {
    ...
    _authenticationBloc.add(
      LoginStarted(email: _emailController.text.trim(), password: _passwordController.text.trim()),
    );
  }
                    ...
                    ListBody(
                      children: <Widget>[
                        ...
                        ClickableRichText(
                          ...
                          plainText: 'Belum punya akun? ',
                          clickableTextData: <ClickableTextData>[
                            ClickableTextData(
                              text: 'Daftar',
                              onTap: () => context.pushNamed(pageRoute: Routes.register),
                            ),
                          ],
